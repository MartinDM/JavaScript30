    ...
    const inventors = [
      ...
      // Map Takes array - creates new array of same length.
      ...
      //   .filter( (road) => road.includes('de') );
        // map followed by filter on 'LINK'
        
      //console.table(de + ' test');
  
      // 7. sort Exercise
      // Sort the people alphabetically by last name
      let list = inventors.sort( (a, b) => {
        if (a.last.charAt(0) ) return 
